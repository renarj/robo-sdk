 ...
 */
public abstract class ExtBaseGpioProvider extends GpioProviderBase implements GpioProvider {
    ...
    public ExtBaseGpioProvider(int busNumber, int address) throws IOException {
    ...
    public ExtBaseGpioProvider(I2CBus bus, int address) throws IOException {
        ...
        monitor = new ExtBaseGpioProvider.ADCMonitor(device);
        monitor.start();
    }
